                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div style="margin-top:1.25rem;padding-top:1.25rem;border-top:1px solid var(--border)">
                            <div style="font-size:.75rem;color:var(--text-muted);margin-bottom:.4rem">Про себе</div>
                            <p style="font-size:.875rem;white-space:pre-wrap">${profile.bio}</p>
                        </div>` : ''}
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                <label>Мітка</label>
                                <input id="prof-label" type="text" placeholder="Наприклад: VIP" value="${profile?.label || ''}">
                            </div>
                        </div>
                        <div class="form-group">
