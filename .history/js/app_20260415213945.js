...
function fieldStyled(label, value) {
    ...
    async editProfile() {
        ...
        container.innerHTML = `
<div style="font-family: -apple-system, BlinkMacSystemFont, 'SF Pro Display', 'SF Pro Text', 'Inter', sans-serif; -webkit-font-smoothing: antialiased; -moz-osx-font-smoothing: grayscale; max-width: 720px; margin: 0 auto;">
    ...
    <div style="background: var(--bg-surface); border-radius: 20px; box-shadow: 0 20px 40px rgba(0,0,0,0.3); border: 0.5px solid rgba(255,255,255,0.06); padding: 36px; backdrop-filter: blur(20px); -webkit-backdrop-filter: blur(20px);">
        ...
        <div style="display: flex; flex-direction: column; gap: 24px;">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                ${formField('ПІБ', 'prof-name', 'text', profile?.full_name || '', 'Іван Іваненко')}
                ${formField('Логін', 'prof-login', 'text', profile?.login || '', 'ivan_ivanov')}
            </div>
...
// Вспомогательная функция для полей ввода в Apple-стиле
