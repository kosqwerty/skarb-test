        ...
        el.innerHTML = `
            <div style="display:flex;gap:1rem;margin-bottom:1rem;flex-wrap:wrap">
                ...
                <select id="role-filter" onchange="AdminPage._renderUsers(document.getElementById('admin-content'))">
                    ...
                    <option value="student">Експерти оцінювачі</option>
                    <option value="student">Стажери</option>
                </select>
            ...
            <div class="table-wrapper">
                <table>
                    <thead>
                        <tr><th>Ім'я</th><th>Email</th><th>Роль</th><th>Зареєстрований</th><th>Статус</th><th>Дія</th></tr>
                    </thead>
