                ...
                <table>
                    <thead>
                        <tr class="filter-row">
                            ...
                            <th style="vertical-align:top;padding-top:.7rem;text-align:center">
                                <button class="btn-reset-filters" onclick="AdminPage._clearUserFilters()" title="Скинути всі фільтри">↺</button>
                            </th>
                        </tr>
                    </thead>
            ...
            <div class="uf-form" style="max-width:520px">
                ...
                <div class="uf-row">
                    ...
                    <div class="gender-picker">
                        ...
                        <button type="button" class="gender-btn" onclick="this.closest('.gender-picker').querySelector('input').value='male';this.closest('.gender-picker').querySelectorAll('.gender-btn').forEach(b=>b.classList.remove('active'));this.classList.add('active')"><span class="gender-icon">♂</span>Чоловік</button>
                        <button type="button" class="gender-btn" onclick="this.closest('.gender-picker').querySelector('input').value='female';this.closest('.gender-picker').querySelectorAll('.gender-btn').forEach(b=>b.classList.remove('active'));this.classList.add('active')"><span class="gender-icon">♀</span>Жінка</button>
                    </div>
                </div>
                <div class="uf-row">
