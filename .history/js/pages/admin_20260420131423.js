        ...
        <div class="create-form-grid">
            ...
            <div class="form-section glass-panel">
                ...
                <div class="input-group">
                    <label class="input-label">
                        ...
                        <input id="cu-last-name" type="text" placeholder="Іваненко" autocomplete="off">
                    </label>
                    <label class="input-label">
                        <span>Ім'я <span class="required-star">*</span></span>
                        <input id="cu-first-name" type="text" placeholder="Іван" autocomplete="off">
                    </label>
                    <label class="input-label">
                        <span>По батькові</span>
                        <input id="cu-patronymic" type="text" placeholder="Іванович" autocomplete="off">
                    </label>
                </div>
            </div>
            ...
            <div class="form-section glass-panel">
                ...
                <div class="input-group">
                    <label class="input-label">
                        ...
                        <input id="cu-login" type="text" placeholder="ivan.ivanov" autocomplete="off">
                    </label>
                    <label class="input-label">
            ...
            <div class="form-section glass-panel">
                ...
                <div class="input-group">
                    ...
                    <label class="input-label">
                        <span>Мітка</span>
                        <input id="cu-label" type="text" placeholder="Наприклад: VIP, Стажер, Віддалена робота">
                    </label>
                </div>
            </div>
        </div>
