            ...
            <div class="card" style="margin-bottom:2rem">
                <div class="card-header">
                    ...
                    <div style="display:flex;gap:.5rem">
                        <input type="text" id="student-search" placeholder="Поиск студента..." style="width:200px" onkeyup="AnalyticsPage.filterStudents(event)">
    ...
    _renderStudentRows(rows, el) {
        ...
        el.innerHTML = `
            <table>
                <thead>
                    <tr>
                        <th>Студент</th><th>Email</th><th>Курсов</th><th>Завершено</th><th>Ср. прогресс</th>
                    </tr>
                </thead>
                <tbody>
                    ${rows.map(r => {
