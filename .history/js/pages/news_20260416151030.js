...
const NewsPage = {
    ...
    async _viewArticle(container, id) {
        ...
        try {
            ...
            container.innerHTML = `
                <style>
                    .nv-layout{display:grid;grid-template-columns:1fr 280px;gap:1.5rem;align-items:start;max-width:1400px;margin:0 auto}
                    ...
                    <div>
                        ...
                        <div class="card">
                            <div class="card-body" style="padding:2.5rem">
                                ...
                                <div style="display:flex;align-items:center;gap:1.5rem;color:var(--text-muted);font-size:.875rem;margin-bottom:${news.allow_reactions !== false ? '1rem' : '2rem'};padding-bottom:1.5rem;border-bottom:1px solid var(--border)">
                                ...
                                ${news.allow_reactions !== false ? `
                                    <div style="display:flex;align-items:center;gap:.75rem;margin-bottom:2rem;padding-bottom:1.5rem;border-bottom:1px solid var(--border)">
                                        <span style="font-size:.85rem;color:var(--text-muted)">Оцінити:</span>
                                        <button id="btn-react-up" class="btn btn-ghost btn-sm" onclick="NewsPage._react('${news.id}','up')" style="font-size:.95rem">
                                            👍 <span id="react-up-count">—</span>
                                        </button>
                                        <button id="btn-react-down" class="btn btn-ghost btn-sm" onclick="NewsPage._react('${news.id}','down')" style="font-size:.95rem">
