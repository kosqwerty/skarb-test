                        ...
                        <div class="card">
                            <div class="card-body" style="padding:2.5rem">
                                ...
                                <div style="display:flex;align-items:center;gap:1.5rem;color:var(--text-muted);font-size:.875rem;margin-bottom:2rem;padding-bottom:1.5rem;border-bottom:1px solid var(--border)">
                                    ...
                                    ${news.allow_reactions !== false ? `
                                        <span>Оцінити:</span>
                                        <button id="btn-react-up" class="btn btn-ghost btn-sm" onclick="NewsPage._react('${news.id}','up')" style="font-size:.95rem; padding:.2rem .6rem; display:inline-flex; align-items:center; gap:0.2rem;">
                                            👍 <span id="react-up-count">—</span>
                                        </button>
                                        <button id="btn-react-down" class="btn btn-ghost btn-sm" onclick="NewsPage._react('${news.id}','down')" style="font-size:.95rem; padding:.2rem .6rem; display:inline-flex; align-items:center; gap:0.2rem;">
