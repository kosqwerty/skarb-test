...
// ── Свята України ────────────────────────────────────────────────
const UA_HOLIDAYS = {
    '01-01': { name: 'Новий рік', emoji: '🎆', type: 'state', tag: 'Державна дата' },
    '03-08': { name: 'Міжнародний жіночий день', emoji: '💐', type: 'state', tag: 'Державна дата' },
    '04-12': { name: 'Великдень (Пасха) 2026', emoji: '🐣', type: 'state', tag: 'Державна дата' },
    '05-01': { name: 'День праці', emoji: '⚒️', type: 'state', tag: 'Державна дата' },
    '05-08': { name: "День пам'яті та перемоги над нацизмом", emoji: '🌻', type: 'state', tag: 'Державна дата' },
    ...
    '06-28': { name: 'День Конституції України', emoji: '📜', type: 'state', tag: 'Державна дата' },
    ...
    '08-24': { name: 'День незалежності України', emoji: '🌻', type: 'state', tag: 'Державна дата' },
    ...
    '10-01': { name: 'День захисників і захисниць України', emoji: '🛡️', type: 'state', tag: 'Державна дата' },
    ...
    '12-25': { name: 'Різдво Христове', emoji: '⭐', type: 'state', tag: 'Державна дата' },
};
